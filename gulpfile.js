...
gulp.task('rename', function ()  {
    var newname;
    var author = 'André Iske';
    var email  = 'andre.iske@mailbox.org';
    ...
    if (!newname) {
        console.log('Please write the new volumio name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/volumio.png')) {
        fs.renameSync(__dirname + '/admin/volumio.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/volumio.html')) {
        fs.renameSync(__dirname + '/widgets/volumio.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/volumio/js/volumio.js')) {
        fs.renameSync(__dirname + '/widgets/volumio/js/volumio.js', __dirname + '/widgets/volumio/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/volumio')) {
        fs.renameSync(__dirname + '/widgets/volumio',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /volumio/g,
        ...
        {
            match: /Volumio/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Volumio'
        },
        {
            match: /André Iske/g,
            replacement: author
        ...
        {
            match: /andre.iske@mailbox.org/g,
            replacement: email
        }
    ];
    var files = [
